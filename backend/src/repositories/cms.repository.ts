    ...
    async seedDefaultHomepageData() {
      ...
      const defaultSections = [
        ...
        },
        {
          ...
          subtitle: "About Onboard",
          content: JSON.stringify({
            description: "At Onboard, we believe accounting isn't just about numbers — it's about building confidence in your financial decisions. Based in Victoria, our team provides end-to-end accounting and tax services tailored for individuals and SMEs across Australia.",
        ...
        },
        {
          ...
          title: "Onboard Team",
          subtitle: "Leadership, Onboard",
          content: JSON.stringify({
            quote: "At Onboard, we believe accounting isn't just about numbers — it's about building confidence in your financial decisions.",
            image: "",
      ...
      const defaultTestimonials = [
        {
          ...
          content: "Onboard transformed our financial management. Their expertise saved us over $30,000 in the first year alone. Highly professional and always responsive!",
          rating: 5,
        ...
        },
        {
          ...
          content: "As a property investor, tax compliance was overwhelming. Onboard simplified everything and helped me maximize deductions. Their team is exceptional!",
          rating: 5,
        ...
        },
        {
          ...
          content: "The cloud accounting setup was seamless. I can now focus on growing my business while Onboard handles all the financial complexities. Best decision ever!",
          rating: 5,
        ...
        },
        {
          ...
          content: "From BAS lodgements to tax optimization, Onboard has been a game-changer. They're always available when I need them. 98.4% response rate is real!",
          rating: 5,
        ...
        },
        {
          ...
          content: "Government grants assistance was outstanding. Onboard helped us secure significant funding and navigate all compliance requirements. Truly grateful!",
          rating: 5,
        ...
        },
        {
          ...
          content: "Starting a business is stressful enough. Having Onboard handle all financial aspects gave me peace of mind. Professional, efficient, and reliable.",
          rating: 5,
